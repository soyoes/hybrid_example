...
style_t style_merge(style_t custom, style_t base){
    ...
    if(custom.placeHolderColor) ss.placeHolderColor = custom.placeHolderColor;
...
style_t style_t::operator=(style_t s){
    ...
    placeHolderColor = (s.placeHolderColor != NIL) ? s.placeHolderColor : NIL;
...
style_t style_t::operator<(style_t s){
    ...
    if(s.placeHolderColor!= NIL) placeHolderColor = placeHolderColor;
