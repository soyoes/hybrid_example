...
extern bool __has_firstResponder;
extern int __firstResponder_idx;
...
public:
    ...
    __attribute__((overloadable)) $& setPickable(arr_t opts, EditHandler startEdit);
    __attribute__((overloadable)) $& setPickable(date_t date, str_t labelFormat, EditHandler startEdit);
    
    __attribute__((overloadable)) $& setEditable(BOOL editable);
    __attribute__((overloadable)) $& setEditable(BOOL editable, EditHandler startEdit);
...
class top_controller_t : public controller_t {
public:
    void init();
};
...
__attribute__((overloadable))float   numf(num_t n, num_t n2, float defaultValue);
__attribute__((overloadable))int     numi(num_t n);
__attribute__((overloadable))int     numi(num_t n, float defaultValue);
__attribute__((overloadable))long    numl(num_t n);
__attribute__((overloadable))long    numl(num_t n, long defaultValue);
